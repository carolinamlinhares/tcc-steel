...
var resultsimples, situationD, situationLN;
var dll, xd, m1d, m2d, tlsd, ascomp, as1, as2, astracao, resultdupla;
...
function processFormDC() {
    ...
    dll = Number(document.formDC.dllDC.value);
    ...
    if (situationD = "Aprovado" && situationLN = "Aprovada") {
        ...
        //Resultados
        resultdupla = "Área de aço comprimida = "+ascomp+"Área de aço tracionada = "+astracao;
        alert(resultdupla);
